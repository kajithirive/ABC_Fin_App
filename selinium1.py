...
name.send_keys('Kaji')
email.send_keys('kajithiriveedhi@gmail.com')
age.send_keys('24')
...
#if result[0][1] == "Kaji" and result[0][2] == "kajithiriveedhi@gmail.com" and result[0][3] == "33" and result[0][4] == "1" and result[0][5] == "0" and result[0][6] == "2" and result[0][7] == "1" and result[0][8] == "1" and result[0][9] == "0.0" and result[0][10] == "0.0" and result[0][11] == "0" and result[0][12] == "0.0" and result[0][13] == "0" and result[0][14] == "2": 
